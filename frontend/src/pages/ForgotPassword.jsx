...
function ForgotPassword() {
  ...
  const handleRequestReset = async (e) => {
    ...
    try {
      const res = await axios.post("https://auth-system-3gpb.vercel.app/api/auth/forgot-password", { email });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await axios.post("https://auth-system-3gpb.vercel.app/api/auth/reset-password", {
        token,
        newPassword,
      });
      setMessage(res.data.message);
